...
## Efeito de Partículas Douradas no GlowButton
- [x] Criar efeito de partículas douradas no hover
- [x] Animar partículas subindo ao redor do botão
- [x] Usar Framer Motion para animações suaves
- [x] Partículas com gradiente radial dourado e glow
- [x] Geração contínua de partículas durante hover
